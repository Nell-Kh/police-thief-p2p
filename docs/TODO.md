...
| 8.7 | League interop kit (class repo): vendored vectors + conformance suite (11 tests) | P0 | nell | ✔ |
| 8.7a | Interop handshake: flat signed terms, pairing declaration, locked-model hashes | P0 | nell | ✔ |
| 8.7b | At-least-once delivery: dedupe on commit, bounded reorder buffer (kit §7.1) | P0 | nell | ☐ |
| 8.7c | Kit-shape capture final: claim_response caught:true + audit corroboration (kit §3.1) | P0 | nell | ☐ |
| 8.7d | Report alignment: consensus signature (spaced form), trimmed scope, league fields (kit §6) | P0 | nell | ☐ |
| 8.7e | Sparring selfplay vs the kit's training opponent — full six-sub-game series clean | P0 | nell | ☐ |
